...
?>
    <main class="content">
            <section class="reviews">
                <div class="reviews__container">
                    <div class="content__text-block">
                        <div class="content__tittle">Take care of your <span>recognition</span></div>
                        <div class="content__text reviews__text">
                            <p1>E-mailGo is a simple and very convenient tool for sending promotional mail. Sending
                                letters
                                is carried out from ready-made templates for your client base.</p1><br>
                    ...
                    <div><img src="/img/illustration1.svg" alt=""></div>
            </section>

            <section class="support">
                <div class="support__container">
                    <div><img src="img/question.svg" alt="question"></div>
                    <div class="content__text-block">
                        <div class="content__tittle"><span>Stay</span> with our experts</div>
                        <div class="content__text support__text">
                            <p1>24x7 Support and user friendly feedback to maintain a comfortable work environment.
                                Any issues are resolved as quickly as possible.</p1><br>
                            <p1>Our company always adheres to the customer's side. We also have a simple feedback form.
                                Service staff carefully selected - there is the possibility of communication in 12
                                languages
            ...
            <section class="features">
                <div class="support__container">
                    <div><img src="img/strategy.svg" alt="question"></div>
                    <div class="content__text-block">
                        <div class="content__tittle"><span>Build</span> your strategy</div>
                        <div class="content__text features__text">
                            <p1>Still not sure?
                                We offer free messaging to a limited number of users. One way or another, you have
                                nothing
                                to lose except a couple of minutes.</p1><br>
                            <p1>Building a customer base, marketing performance analytics, an open community and much
                                more
