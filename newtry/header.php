...
<head>
    ...
    <title>Email</title>
    <link href="https://fonts.googleapis.com/css2?family=Raleway:wght@700&family=Rubik:wght@400;700&display=swap"
        rel="stylesheet">
        ...
        <header class="header">
            <div class="header__container">
                ...
                <div class="header__button">
                    <a href="workspace.php" class="button__visual">
                        <div class="button__text">TRY IT</div>
                    </a>
                </div>
            </div>
        </header>